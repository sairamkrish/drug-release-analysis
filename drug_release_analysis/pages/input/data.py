...
def handle_concentration():
    ...
    return create_model_from_file_upload(uploaded_file, model, sample_file_url, st.session_state.get("concentration"))
...
def handle_absorbance_observation():
    ...
    return create_model_from_file_upload(uploaded_file, model, sample_file_url, st.session_state.get("observation"))


# @st.cache_data
def create_model_from_file_upload(uploaded_file, model, sample_file_url, session_value):
